    ...
    def create_control_table_if_not_exists(self, dataset_id, control_table_id):
        ...
        try:
            ...
            query = f"""
                ...
                VALUES 
                    ('conecta', 'EnvioSMTR', '{datetime.utcnow().isoformat()}', 'success'),
                    ('conecta', 'envioViagensSMTR', '{datetime.utcnow().isoformat()}', 'success'),
                    ('conecta', 'EnvioViagensRetroativasSMTR', '{datetime.utcnow().isoformat()}', 'success')
            """
